...
KyrieAltoNotes = {
  \relative c' {
    \clef treble
    \key g \dorian \time 2/1 \tempoKyrie \autoBeamOff
...
GloriaAltoNotes = {
  \relative c' {
    \clef treble
    \key g \dorian \time 2/1 \tempoGloria \autoBeamOff
      \set Staff.timeSignatureFraction = 2/2
    R\breve
    g'2 f es d
    c2. c4 b2. b4
...
CredoAltoNotes = {
  \relative c' {
    \clef treble
    \key g \dorian \time 2/1 \tempoCredo \autoBeamOff
      \set Staff.timeSignatureFraction = 2/2
    g'1 d2 g
    f es d1
    es2 d es4( f) g2
...
SanctusAltoNotes = {
  \relative c' {
    \clef treble
    \key g \dorian \time 2/1 \tempoSanctus \autoBeamOff
      \set Staff.timeSignatureFraction = 2/2
    r1 r2 g'~
    g\breve~
    g1. d2
...
BenedictusAltoNotes = {
  \relative c' {
    \clef treble
    \key g \dorian \time 3/1 \tempoBenedictus \autoBeamOff
...
AgnusDeiAltoNotes = {
  \relative c' {
    \clef treble
    \key g \dorian \autoBeamOff \tempoAgnus \time 2/1
      \set Staff.timeSignatureFraction = 2/2
    R\breve
    r2 d1 c2
    d1 e2 e
