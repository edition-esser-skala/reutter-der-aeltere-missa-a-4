...
KyrieOrgano = {
  \relative c {
    \clef "treble_8"
    \key g \dorian \tempoKyrie \time 2/1
...
KyrieBassFigures = \figuremode {
  ...
  <\t>2 <[6]> <6\\>1
  <7>2 <[6\\]> r1
  r2 \bo <[7]>4 <6> r2 <_-> \bc <[7] _+>1 %25
  <5 _+>2 \bassFigureExtendersOn <5 4>1 <5 _+>2 \bassFigureExtendersOff
  r\breve %27 finis
  r
  r
  r1. <[6]>2 %30
...
GloriaOrgano = {
  \relative c {
    \clef bass
    \key g \dorian \tempoGloria \time 2/1
      \set Staff.timeSignatureFraction = 2/2
    r2 g'1 f2
    es d c b
    a1 g2 g'~
...
GloriaBassFigures = \figuremode {
  ...
  <7> <6\\> r1
  <_+> <7>2 <6>
  \bo <[\t \l]>4 <6> <6 4!> \bc <[\t \t]> <5 _->2 <6>
  <_+>1 \bo <[6 \l]>2 <6 _->4 \bc <[5 \l]> %10
  \bo <[5] _+>2 <6 4>1 \bc <[5] _+>2
  <[_!]>1 <5>
  <6> <5>2 <6>
  <5>1 q
  r\breve %15
  ...
  \bo <[8] 6>2 <7 5> <6 4>4 \bc <[5] _+>2.
  \bo <[6 4]>2 <5 \t>4 <\t _+> \bc <[\t _!]>1
  <_-> <6> %95
  <_->\breve
  <_!> %97 FINIS
}
...
CredoOrgano = {
  \relative c {
    \clef treble
    \key g \dorian \time 2/1 \tempoCredo
      \set Staff.timeSignatureFraction = 2/2
    g''1 d2 g
    << {
      r1 d'
...
CredoBassFigures = \figuremode {
  ...
  r
  r\breve \bo <[6 _-]>1
  <6>\breve \bc <[6\\ \l]>1 %115
  <6 3> \bassFigureExtendersOn q q
  <5> q \bassFigureExtendersOff \bo <[10- 8]>
  \bc <[9 7]> <4> <_+>
  \bo <[_!]>\breve.
  r1 <3>2 <7>4 <\t> %120
  <6>2 <3> \bc <[_-]> <5 _->
...
SanctusOrgano = {
  \relative c {
    \clef bass
    \key g \dorian \time 2/1 \tempoSanctus
      \set Staff.timeSignatureFraction = 2/2
    g'\breve
    g
...
SanctusBassFigures = \figuremode {
  ...
  <\t \t> <_+>
  <7>2 <6> <_+> <5> %15
  <6>2. \bo <[_-]>4 \bc <[6] 4>2 <\t _+>
  r\breve
  <4->2 <3> <6>1
  <8>2 <[6]>4 <5>
  <_->2 <[6]> r <6> %20
  <[7]> <6> \bo <[5 3]>4 \bc <[6 4]> <6>2
  <_->1 <6>
  <_->2 <5>2. <\t>
  <6>2 <_!> r1
  r <6>2. <\t>4 %25
...
BenedictusOrgano = {
  \relative c {
    \clef bass
    \key g \dorian \time 3/1 \tempoBenedictus
...
AgnusDeiOrgano = {
  \relative c {
    \clef "treble_8"
    \key g \dorian \time 2/1 \tempoAgnus
      \set Staff.timeSignatureFraction = 2/2
    g'1. f2
    << {
      r2 d'1 c2
